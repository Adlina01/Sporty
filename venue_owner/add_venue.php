...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow" style="background-color: #fcfafa; border: 1px solid #dee2e6;">
                  <div class="card-body">
                    ...
                    <h1 class="h3 mb-4 text-gray-800 font-weight-bold" style="font-family: 'Signika Negative', sans-serif;">ADD VENUE</h1>


                    <h5 class="card-title font-weight-bold" style="font-family: 'Inconsolata', monospace;">Please fill in all the information below</h5>
                ...
                <!--Venue ID & Venue Name-->
                 <form action="add_venue_backend.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                 <div class="row">
                    ...
                    <input type="text" class="form-control" id="venuename" name="venuename" placeholder="ex : Futsal Kpz" required>
                 </div>

                <div class="col-md-6">
                <legend><span class="number">2</span>Number of Venue</legend>
                <input type="text" class="form-control" id="venuenumber" name="venuenumber" placeholder="ex : 1" pattern="[0-9]+" required>
                </div>
              </div>
            </div>
           ...
           <textarea rows="3" class="form-control" id="address" name="address" placeholder="ex : Gelanggang Futsal, Kolej Pendeta Za'ba, 43600 UKM Bangi " required></textarea>
            </div>
            ...
            <div class="form-group">    
                 <div class="row">
                    <div class="col-md-6">
                    <legend><span class="number">4</span>Price (RM) per Session</legend>
                    <input type="text" class="form-control" id="price"name="price" placeholder="ex : 00.00" required="">
                    </div>

                    <div class="col-md-6">
                    <legend><span class="number">5</span>Sport Category</legend>
            ...
            <!--Open time & Close Time-->
              ...
              <div class="form-group">    
                 <div class="row">
                    ...
                    <input class="form-control" id="otime" name="otime" type="time" required oninput="setMinutesToZero('otime')">
                    </div>

                     <div class="col-md-6">
                    <legend><span class="number">7</span>Close Time</legend>
                    <input class="form-control" id="ctime" name="ctime" type="time" required oninput="setMinutesToZero('ctime')">
                    </div>
                </div>
              </div>
              ...
              <div class="form-group">    
                 <div class="row">
                    <div class="col-md-6">
                    <legend><span class="number">8</span>Duration per Session</legend>
              ...
              <!--Cancel button-->
                ...
                <button type="submit" name="submit" class="btn btn-fancy" style="background-color: #0722ba;">Submit</button>
                </div>
            </div>
            </form>
            <!-- End Basic Form -->
...
<script>
    // Function to set the minutes to 0 for a given time input field
    function setMinutesToZero(inputId) {
        var timeInput = document.getElementById(inputId);

        if (timeInput.value) {
            var timeComponents = timeInput.value.split(':');
            timeInput.value = timeComponents[0] + ':00';
        }
    }
</script>
</script>
